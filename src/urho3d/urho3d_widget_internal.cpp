...
Urho3DWidgetInternal::Urho3DWidgetInternal(Urho3D::Context* context, QWidget* parent)
    : QWidget(parent),
...
Urho3DWidgetInternal::~Urho3DWidgetInternal() {}

void Urho3DWidgetInternal::Start() {
    ...
    setupViewport();
    SubscribeToEvent(E_UPDATE, URHO3D_HANDLER(Urho3DWidgetInternal, HandleUpdate));
}

void Urho3DWidgetInternal::Stop() {
    if (engine_.NotNull() && engine_->IsInitialized()) {
        engine_->Exit();
    }
}

void Urho3DWidgetInternal::Setup() {
...
void Urho3DWidgetInternal::closeEvent(QCloseEvent* e) {
    e->accept();
    engine_->Exit();
}

void Urho3DWidgetInternal::timerEvent(QTimerEvent* e) {
...
void Urho3DWidgetInternal::resizeEvent(QResizeEvent* e) {
...
void Urho3DWidgetInternal::keyPressEvent(QKeyEvent* e) {
...
void Urho3DWidgetInternal::HandleUpdate(Urho3D::StringHash eventType,
...
void Urho3DWidgetInternal::createScene() {
...
void Urho3DWidgetInternal::setupViewport() {
...
void Urho3DWidgetInternal::MoveCamera() {
